// ========================================
// ネクステSRS - GASコード v1.0
// 作成日時: 2026-03-25T22:00:00+09:00
// ベース: シス単SRS v5.1 からのフォーク
// ========================================
// 設計書v1.1 フォーク変更チェックリスト対応:
//   No.3:  SHEET_NAME_DATA → NS_SRS_Data
//   No.4:  SHEET_NAME_META → NS_SRS_Meta
//   No.5:  COL定数 → PHRASE/MEANING廃止、列番号繰り上げ
//   No.6:  DATA_COLS → 12→10
//   No.7:  HEADER_ROW → phrase/meaning列削除
//   No.17: SPREADSHEET_ID → デプロイ時に差替
//   No.19: idバリデーション → 文字列型、空文字/50文字超チェック
//   No.20: id型変換 → Number()キャスト除去、文字列のまま保存
//   No.21: ソート順 → 数値ソート→文字列辞書順
// ========================================
...
var SPREADSHEET_ID = "1pn_Cb9DmrqBk3N_QeEymAxBMjhbW4vT1dZjakEx4y6I";

// シート名（★No.3, No.4: シス単と衝突しない名前）
var SHEET_NAME_DATA = "NS_SRS_Data";   // シス単: SRS_Data_v5
var SHEET_NAME_META = "NS_SRS_Meta";   // シス単: SRS_Meta
...
function runAllTests() {
  Logger.log("========================================");
  Logger.log("ネクステSRS GAS テスト実行 - " + new Date().toISOString());
  Logger.log("========================================");
